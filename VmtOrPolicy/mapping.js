...
module.exports = function mapping(input) {
    ...
    const isInternetAcquiring = input.body.paymentData.paymentMethod == enums.paymentMethod.internetAcquiring;
    ...
    const insuredPremiumLiteral = numberToWordsCurrency(insuredPremium, "", false, false, true);
    ...
    const isResident = policyHolder?.resident;
    const policyHolderCitizenship = isResident ? 'РФ' : tr.getEnum('PartyCountry', _ => policyHolder?.attributes?.registrationCountry, 'PartyCountry');
